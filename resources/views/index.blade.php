    ...
    <div class="container pt-5">
        <div class="row">
            ...
            <div class="col-md-4 order-md-1 col-lg-3 sidebar-filter">
                <h3 class="mt-0 mb-5">{{ __("shop.product.showing") }} <span class="text-primary">{{ __('shop.product.number', ['number' => count($products)]) }}</span> {{ __("shop.product.products") }}</h3>
...
{{--                <input id="ex2" type="text" class="slider " value="50,150" data-slider-min="10" data-slider-max="200" data-slider-step="5" data-slider-value="[50,150]" data-value="50,150" style="display: none;">--}}
                ...
                <a href="#" class="btn btn-lg btn-block btn-primary">{{ __('shop.product.filter_products') }}</a>
            </div>
